...
class Usuario extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = [
        'username', 'rol', 'nombres', 'apellidos', 'dni', 'correo', 'edad', 'nacimiento', 'sexo', 'direccion', 'telefono', 'departamento', 'password', 'status', 'perfil','emailVerified','verification_token','fecha_creado',
    ];
